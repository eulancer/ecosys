...
def main():
    ...
    df_result_stock_org = df_result[(df_result['buyer'] == '机构专用')]
    ...
    df_result_stock_price = df_result[(df_result['price'] > df_result['close'])]
    ...
    df_result_stock = df_result[(df_result['buyer'] == '机构专用') & (df_result['price'] >= df_result['close'])]
